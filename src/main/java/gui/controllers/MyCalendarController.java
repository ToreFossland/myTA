	...
	public void initialize() {
		...
		HBox[][] boxesInitialized = {
				...
				{ box17, box18, box19, box20, box21, box22, box23, box24, box25, box26, box27, box28, box29, box30,
						box31, box32 },
				{ box33, box34, box35, box36, box37, box38, box39, box40, box41, box42, box43, box44, box45, box46,
						box47, box48 },
				{ box49, box50, box51, box52, box53, box54, box55, box56, box57, box58, box59, box60, box61, box62,
						box63, box64 },
				{ box65, box66, box67, box68, box69, box70, box71, box72, box73, box74, box75, box76, box77, box78,
						box79, box80 }
		...
		Text[][] textInitialized = {
				{ text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, text11, text12, text13, text14,
						text15, text16 },
				{ text17, text18, text19, text20, text21, text22, text23, text24, text25, text26, text27, text28,
						text29, text30, text31, text32 },
				{ text33, text34, text35, text36, text37, text38, text39, text40, text41, text42, text43, text44,
						text45, text46, text47, text48 },
		...
		for (Booking booking : DBBooking.getBookingsTA()) {
			if (booking.getEmailStudent() != null && booking.getWeek() >= currentWeek
					&& !weeks.contains(booking.getWeek()))
